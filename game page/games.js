...
function wizardly(){
    window.open("./../game2/game page/game instr/wizardinstruction.html","_self")// refering to the game1 intruction page 
}
function mole(){
    window.open("./../game1/gameinstr/moleInstruction.html","_self")//refering to the game2 instruction page 
}